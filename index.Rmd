...
<p class="comment">
The cost of the activity  would be a minimum of 25€ per person, including the box, the gifts to be put inside, and the 6€ donation (mandatory).</p>
...
<img src = "http://esfericgroup.com/wp-content/uploads/2018/09/Esferic-1.jpg" width="800">

The idea would be to organize the activity (Operation Christmas Child) at the lower floor, the Brossa room setting some tables outside and some inside. 

<img src = "http://www.deuideu.com/wp-content/uploads/2013/08/028.jpg" width="800">

After finishing the activity guests will go to the upper floor to have a cocktail dinner. This room is called Vidreres (big windows) and it is a special room with a unique roof. It has a terrace that will be used for our cocktail in case of good weather.

<img src = "vidreres2.png" width="800">

<img src = "vidreres.png" width="800">
...
<p class="comment">
**Venue rental from 17.00h to 19.00h to organize the activity** (including the rental and setup of the tables): **2.200€ VAT inc** - this rate is only valid if we contract the cocktail dinner after the activity.</p>
...
<p class="comment">
No drinks and no waiter service included during the activity .</p>

We can use this venue for both activity + dinner or just dinner in case the group chose another activity.
...
<p class="comment">
**Cocktail menu including drinks, from: 66,50€ VAT inc per person.** Venue rental free of charge if we contract a minimum of 280 pax  .</p>
...
<p class="comment">
Mandatory: Security service: 400€ VAT inc
// Optional: façade lighting: 375€ VAT inc.// Optional: cloackroom service: 500€ VAT inc</p>
